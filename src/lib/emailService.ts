            ...
            <div class="qr-event-flex">
                <div class="qr-section">
                    <div class="qr-container">
                        <img src="${ticketData.qrCodeDataUrl}" alt="Código QR del Ticket" style="max-width: 180px; max-height: 180px; border: none; outline: none;" />
                    </div>
                    <div class="qr-label">📱 Escanea para validar</div>
                </div>
                
                <div class="event-photo">
                    <div style="width: 180px; height: 180px; background: linear-gradient(135deg, #FF6B9D, #4A90E2, #7B68EE); border-radius: 15px; border: 4px solid #FF6B9D; box-shadow: 0 10px 30px rgba(75,144,226,0.4); margin-bottom: 10px; display: flex; align-items: center; justify-content: center; color: white; font-weight: 800; font-size: 18px; text-align: center; line-height: 1.2;">BOUNCE2<br>BOUNCE<br><span style="font-size: 14px; opacity: 0.9;">IMPCORE<br>ANIVERSARIO</span></div>
